...
//Mensagem de Erro
$msg_erro = "Atenção!! Os campos (Nome, E-mail e Defeito ) não podem estar em branco.";
...
if ($nome!="" and $defeito and $email!="")
	...
	if (mail($mail_destino, "Orçamento ProSCell: $equipamento", $msg, "From:$nome<$email>"))
		{
		...
		echo 
			...
			echo "<b>Olá! $nome</b>,<br><br>sua mensagem:<br> <font color=\"#FF0000\"><b>$defeito </b></font><br>Foi enviada com sucesso!<br><br>";
		...
		//Enviando mensagem de confirmação para o email do internauta
		 mail("$nome<$email>", "Re:Formulário enviado: $equipamento", $msg_reply, "From:<$mail_destino>");
		}
		else
